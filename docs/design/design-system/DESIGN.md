> # ⚠️ KIT DE MARCA — SUBORDINADO AO PROTÓTIPO DA ARENA
>
> A fonte canônica de tokens do jogo é
> [`../DESIGN_SYSTEM.md`](../DESIGN_SYSTEM.md), derivada do protótipo
> [`../prototipo-arena/arena.html`](../prototipo-arena/arena.html). Quando este
> documento divergir dele, o protótipo vence.
>
> As seções 7.3 (XP), 7.4 (Níveis), 7.5 (Conquistas) e 7.6 (Ranking) descrevem
> componentes que **saíram da visão do produto** — ver
> [`../../jogo/VISAO.md`](../../jogo/VISAO.md). Ficam como registro do trabalho
> de marca, não como componentes a construir.
...
Estes tokens **não existiam na v1** — cobrem sucesso, vitória, derrota, ranking e erro, cobertura herdada da especificação de UX anterior (arquivada).
...
## 14. Cobertura vs. a especificação de UX anterior — checklist herdado
